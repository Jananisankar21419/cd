...
import Background from "../../../public/yo3.webp";
  ...
  return (
    <div className="relative h-[60vh] md:h-[80vh] overflow-hidden flex items-center bg-[#F5EDED] border-t border-[#A54A69]">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 md:px-8">
        ...
        <Link
          href="/menu"
          className="flex items-center border border-[#A54A69] text-[#A54A69] px-4 py-2 rounded-full bg-transparent hover:bg-[#A54A69] hover:text-white transition-colors"
        >
          Categories
